...
const updateReserva = async (id, reserva) => {
  try {
    const response = await axiosInstance.put(`/${id}`, reserva);
    return response.data;
  } catch (error) {
    console.error(`Erro ao atualizar reserva com ID ${id}:`, error);
    throw error;
  }
};
...
const deleteReserva = async (id) => {
  try {
    ...
    console.error(`Erro ao deletar reserva com ID ${id}:`, error);
    throw error;
  }
};
